...
(define-search-engine peertube
  ...
  (nsfw "nsfw" ((t "both")
                (nil "false")))
  (published-date "publishedDateRange" ((:year "last_365days")
                                        (:month "last_month")
                                        (:week "last_7days")
                                        (:today "today")
                                        (:any "any_published_date")))
  (is-live "isLive" ((t "both")
                     (nil "false")))
  (duration "durationRange" ((:any "any_duration")
                             (:short "short")
                             (:medium "medium")
                             (:long "long")))
  (category "categoryOneOf" ((:music "1")
                             (:films "2")
                             (:vehicles "3")
                             (:art "4")
                             (:sports "5")
                             ...
                             (:kids "17")
                             (:food "18")))
  (licence "licenceOneOf" ((:attr "1")
                           (:attr-share "2")
                           (:attr-noderivatives "3")
                           (:attr-noncommercial "4")
                           (:attr-noncommercial-share "5")
                           (:attr-noncommercial-noderivates "6")
                           (:public-domain "7")))
  (language "languageOneOf" ((:english "en")
                             (:french "fr")
                             (:japanese "ja")
                             (:euskara "eu")
                             (:catalan "ca")
...
(define-search-engine sourcehut
  ...
  (sort "sort" ((:recent "recently-updated")
...
(define-search-engine libgen
  ...
  (results "res" ((:twenty-five "25")
                  (:fifty "50")
                  (:hundred "100")))
  (covers "covers" ((t "on")
                    (nil "")))
  (chapters "showch" ((t "on")
                      (nil "")))
  (google-mode "gmode" ((t "on")
                        (nil "")))
  (unsorted-search "filesuns" ((t "on")
                               (nil "")))
  (field "columns%5B%5D" ((:title "t")
                          ...
                          (:publisher "p")
                          (:isbn "i")))
  (objects "objects%5B%5D" ((:files "f")
                            (:editions "e")
                            (:series "s")
                            (:authors "a")
                            (:publishers "p")
                            (:works "w")))
  (topics "topics%5B%5D" ((:libgen "l")
                          (:comics "c")
                          (:fiction "f")
