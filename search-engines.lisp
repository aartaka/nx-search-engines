...
(define-search-engine searx
  ...
  (categories "categories" ((:general "general")
                            ...
                            (:videos "videos")))
  (auto-complete "autocomplete" ((:default "")
                                 (:dbpedia "dbpedia")
  ...
  (interface-language "locale" ((:default "")))
  (time-range "time_range" ((:default "")
                            (:day "day")
                            (:week "week")
                            (:month "month")
                            (:year "year")))
  (theme "theme" ((:simple "simple")))
  (style "simple_style" ((:default "")
                         (:auto "auto")
                         (:light "light")
                         (:dark "dark")))
  (safe-search "safesearch" ((:strict "2")
                             (:moderate "1")
                             (:none "0")))
  (center-alignment "center_alignment" ((nil "0")
                                        (t "1")))
  (new-tab "results_on_new_tab" ((t "1")
                                 (nil "0")))
  (infinite-scroll "infinite_scroll" ((t "1")
                                      (nil "0")))
  (request-method "method" ((:get "GET")
                            (:post "POST")))
  (image-proxy "image_proxy" ((t "1")
                              (nil "0")))
  (query-title "query_in_title" ((nil "0")
                                 (t "1"))))
